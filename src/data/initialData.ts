...
export const initialWorkItems: WorkItem[] = [
  ...
  { id: "item-11b", code: "8.04", category: "01 - GROS OEUVRE-REVETEMENT-ETANCHEITE", description: "Fourniture et pose de gargouille plomb et crapaudine.", unit: "U", unitPrice: 1500.00, contractQuantity: 10.0 },
  { id: "item-12b", code: "9.03", category: "09 - MENUISERIE & RESTAURATION BOIS", description: "Restauration des portes d'entrées traditionnelles à panneaux.", unit: "M2", unitPrice: 1200.00, contractQuantity: 20.0 },
  { id: "item-13b", code: "9.07", category: "09 - MENUISERIE WOOD & FERRONNERIE", description: "Fourniture et pose porte panneaux en bois de cèdre massif.", unit: "M2", unitPrice: 2200.00, contractQuantity: 30.0 },
...
export const initialMeasurementLines: MeasurementLine[] = [
  ...
  { id: "m-8-04", itemId: "item-11b", label: "Gargouille en plomb", coefficient: 1, length: 5.00, computedValue: 5.00 },
  
  // Menuiseries
  { id: "m-9-3", itemId: "item-15", label: "Dépose revêtement lizar cèdre", coefficient: 1, length: 91.92, computedValue: 91.92 },
  { id: "m-9-30", itemId: "item-20b", label: "Restauration de cadre cèdre", coefficient: 1, length: 0.64, computedValue: 0.64 },
  { id: "m-9-31", itemId: "item-20c", label: "Frame et grille de protection fer", coefficient: 1, length: 0.90, computedValue: 0.90 },
  { id: "m-9-13a", itemId: "item-14b", label: "Nettoyage fenêtres coulissantes cèdre", coefficient: 1, length: 3.29, computedValue: 3.29 },
  { id: "m-9-13b", itemId: "item-14c", label: "Restauration fenêtres coulissantes cèdre", coefficient: 1, length: 3.29, computedValue: 3.29 },
  { id: "m-9-21D", itemId: "item-15b", label: "Restauration lizar peint décoratif", coefficient: 1, length: 12.50, computedValue: 12.50 },
  { id: "m-9-22a", itemId: "item-16b", label: "Dépose et F,P coupole", coefficient: 1, length: 154.00, computedValue: 154.00 },
  { id: "m-9-22c", itemId: "item-16c", label: "Restauration de lizar", coefficient: 1, length: 33.00, computedValue: 33.00 },
  { id: "m-9-23a", itemId: "item-17b", label: "Coupole Si Moussa : Dépose", coefficient: 1, length: 11.69, computedValue: 11.69 },
  { id: "m-9-23b", itemId: "item-17c", label: "Coupole Si Moussa : Restauration bois", coefficient: 1, length: 21.66, computedValue: 21.66 },
  { id: "m-9-23c", itemId: "item-17d", label: "Coupole Si Moussa : pose Lizar", coefficient: 1, length: 22.65, computedValue: 22.65 },
  { id: "m-9-25", itemId: "item-18b", label: "Plancher en cèdre peint", coefficient: 1, length: 29.96, computedValue: 29.96 },
  { id: "m-9-26", itemId: "item-19b", label: "Restauration de poutres consoles", coefficient: 1, length: 6.76, computedValue: 6.76 },
